...
@pytest.mark.parametrize("tokenizing_names", [
    [
...
def test_esm_vs_faesm_numeric(tokenizing_names, setup_output_dir, batch_size=10, min_seq_length=10, max_seq_length=200, use_fa=True, dtype=torch.float16):
    """
